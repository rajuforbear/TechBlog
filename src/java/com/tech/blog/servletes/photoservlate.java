 ...
 */
@MultipartConfig
public class photoservlate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet photoservlate</title>");            
            out.println("</head>");
            out.println("<body>");
               ...
               boolean ans=   up.updatePhotoName(user);
               ...
               if(ans){
                  ...
                  if(oldImageName.equals("default.png")) {
                   ...
                   {
                        Messege msg = new Messege("profile photo updated","success","alert-success");
                //  HttpSession s =request.getSession();
                  s.setAttribute("msg", msg);
                   }
                   else{
                        Messege msg = new Messege("someting went wrong ! pease try again..","error","alert-danger");
                //  HttpSession s =request.getSession();
                  s.setAttribute("msg", msg);
                   }
