...
<html>
    <head>
        ...
        <title>Welcome  <%=user.getName().toUpperCase()%></title>
        <!-- css -->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"><span class="	fa fa-bell"></span>   LearnCode With Raju <span class="sr-only">(current)</span></a>
                    </li>
                ...
                <ul class="navbar-nav mr-right">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#!" data-toggle="modal" data-target="#profile-modal" > <span class="fa fa-user-circle"></span> <%=user.getName().toUpperCase()%> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="logout_servelete"> <span class="fa fa-user-plus"></span> Log out </a>
                    </li>
                </ul>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container text-center">
                            <img src="pics/<%=user.getProfile()%>" class="img-fluid" style="border-radius: 50%;max-width: 170px">
                            <br>
                            ...
                            <div id="profile-edit" style="display: none;">
                                ...
                                <form action="EditServlete" mathod=post enctype="multipart/form-data" >
                        ...
                        <form id="add-post-form" action="AddPostServelet" method="post">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cid">
                                    ...
                                    <%
                                        PostDao dao = new PostDao(ConnectionProvider.geConnection());
                ...
                $("#add-post-form").on("submit", function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            {
                                swal("Error ! ", "Some Thing Went Worng Try Again...", "error")
                            }
                        },
